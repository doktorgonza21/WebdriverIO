...
describe('Lesson 28 final Test-case 02', () => {
  it(`Fill the registration form with valid data from clicking on website footer 'Sign up for GitHub' button`, async () => {
    // Opens the home page and maximize the window
    await homePage.open('');
    await browser.maximizeWindow();
    // Scrolls to footer 'Sign up for GitHub' button
    await homePage.footerSignUpButtonScroll();
    // Clicks to footer 'Sign up for GitHub' button
    await homePage.footerSignUpButtonClick();
